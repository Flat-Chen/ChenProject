...
from newcar_new.items import AutohomeItem
from selenium import webdriver
# from scrapy.xlib.pydispatch import dispatcher
from scrapy import signals
import requests
# from .items import AutohomeNewcarSpider Item

website = 'autohome_newcar'


class AutohomeNewcarSpider(scrapy.Spider):
    name = website
    ...
    def __init__(self, **kwargs):
        super(AutohomeNewcarSpider, self).__init__(**kwargs)
        self.counts = 0
        self.nationp = dict()
    ...
    custom_debug_settings = {
        ...
        'MYSQL_DB': 'newcar',
        'MYSQL_TABLE': 'autohome_newcar',
        'MONGODB_SERVER': '192.168.1.94',
        'MONGODB_DB': 'newcar',
        'MONGODB_COLLECTION': 'autohome_newcar',
    ...
    def parse_fnf(self, response):
        ...
        for dl in dls:
            ...
            for family in family_list:
                ...
                family_url = response.urljoin(family_url)
                # eg: https://car.autohome.com.cn/price/series-2533.html#pvareaid=2042205
                yield scrapy.Request(url=family_url, meta=dict(meta, **response.meta),
    ...
    def parse_family(self, response):
        ...
        for ps in pss:
            ...
            if ps.xpath("@class").extract_first() != 'current' and ps.xpath("@class").extract_first != 'disabled':
                stop_url = response.urljoin(ps.xpath("a/@href").extract_first())
                yield scrapy.Request(url=stop_url, meta=response.meta,
