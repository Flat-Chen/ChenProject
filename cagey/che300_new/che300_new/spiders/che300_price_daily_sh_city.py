...
website = 'che300_price_daily_sh_city'


class Che300PriceDailyShCitySpider(RedisSpider):
    name = website
    redis_key = "che300_price_daily_sh_city:start_urls"
    ...
    def __init__(self, **kwargs):
        super(Che300PriceDailyShCitySpider, self).__init__(**kwargs)
        self.c = con.client()
    ...
    custom_debug_settings = {
        ...
        'MYSQL_DB': 'che300',
        'MYSQL_TABLE': 'che300_price_daily_sh_city',
        'MONGODB_SERVER': '192.168.2.149',
        'MONGODB_DB': 'che300',
        'MONGODB_COLLECTION': 'che300_price_daily_21_price',
    ...
    def parse(self, response):
        ...
        item["normal_price1"] = html.xpath("//div[@id='car-normal']//li[@class='dealer_low_buy_price stonefont']/text()")[0]
        item["normal_price2"] = html.xpath("//div[@id='car-normal']//div[@class='dealer_buy_price stonefont']/text()")[0]
        item["normal_price3"] = html.xpath("//div[@id='car-normal']//li[@class='individual_low_sold_price stonefont']/text()")[0]
        item["normal_price4"] = html.xpath("//div[@id='car-normal']//div[@class='individual_price stonefont']/text()")[0]
        item["normal_price5"] = html.xpath("//div[@id='car-normal']//li[@class='dealer_low_sold_price stonefont']/text()")[0]
        item["normal_price6"] = html.xpath("//div[@id='car-normal']//div[@class='dealer_price stonefont']/text()")[0]
        item["normal_price7"] = html.xpath("//div[@id='car-normal']//li[@class='dealer_high_sold_price stonefont']/text()")[0]

        item["good_price1"] = html.xpath("//div[@id='car-good']//li[@class='dealer_low_buy_price stonefont']/text()")[0]
        item["good_price2"] = html.xpath("//div[@id='car-good']//div[@class='dealer_buy_price stonefont']/text()")[0]
        item["good_price3"] = html.xpath("//div[@id='car-good']//li[@class='individual_low_sold_price stonefont']/text()")[0]
        item["good_price4"] = html.xpath("//div[@id='car-good']//div[@class='individual_price stonefont']/text()")[0]
        item["good_price5"] = html.xpath("//div[@id='car-good']//li[@class='dealer_low_sold_price stonefont']/text()")[0]
        item["good_price6"] = html.xpath("//div[@id='car-good']//div[@class='dealer_price stonefont']/text()")[0]
        item["good_price7"] = html.xpath("//div[@id='car-good']//li[@class='dealer_high_sold_price stonefont']/text()")[0]

        item["excellent_price1"] = html.xpath("//div[@id='car-excellent']//li[@class='dealer_low_buy_price stonefont']/text()")[0]
        item["excellent_price2"] = html.xpath("//div[@id='car-excellent']//div[@class='dealer_buy_price stonefont']/text()")[0]
        item["excellent_price3"] = html.xpath("//div[@id='car-excellent']//li[@class='individual_low_sold_price stonefont']/text()")[0]
        item["excellent_price4"] = html.xpath("//div[@id='car-excellent']//div[@class='individual_price stonefont']/text()")[0]
        item["excellent_price5"] = html.xpath("//div[@id='car-excellent']//li[@class='dealer_low_sold_price stonefont']/text()")[0]
        item["excellent_price6"] = html.xpath("//div[@id='car-excellent']//div[@class='dealer_price stonefont']/text()")[0]
        item["excellent_price7"] = html.xpath("//div[@id='car-excellent']//li[@class='dealer_high_sold_price stonefont']/text()")[0]

        # item["evalResult"] = str(re.findall("evalResult='(.*?)';", response_.replace(' ', ''))[0])
        item["evalResult"] = json.dumps((json.loads(re.findall("evalResult='(.*?)';", response_.replace(' ', ''))[0])), ensure_ascii=False)
