...
website = 'pcauto_luntan_new'


class PacutoLuntanNewSpider(scrapy.Spider):
    name = 'pcauto_luntan_new'
    ...
    def __init__(self, **kwargs):
        super(PacutoLuntanNewSpider, self).__init__(**kwargs)
        self.counts = 0
        self.headers = {
    ...
    def brand_parse(self, response):
        ...
        url = 'https://mrobot.pcauto.com.cn/xsp/s/auto/info/nocache/bbs/forums.xsp?forumId=28426&pageNo=1&pageSize=20'
