...
def get_be_p1_list():
    ...
    font1 = TTFont(path+'/luntan/tools/text.ttf')
...
def get_map(be_p1, word_list):
    path = os.path.abspath('./')
    font2 = TTFont(path+'/luntan/tools/text2.ttf')
...
if __name__ == "__main__":
    word_list = ['呢', '近', '八', '着', '更', '短', '三', '少', '是', '大', '好', '上', '十', '低', '不', '的', '六', '很', '坏', '长', '右', '高', '四', '五', '一', '二', '了', '下', '左', '得', '多', '远', '七', '九', '地', '小', '和', '矮']
