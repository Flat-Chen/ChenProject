...
class CarSpider(scrapy.Spider):
    ...
    def parse_car(self, response):
        ...
        times = response.xpath('//table[@class="MD-widget-tradedetail-template7-proceduresDetail_new-tbl-info"]//tbody[1]/tr[1]/td[1]/text()').extract_first().strip()
