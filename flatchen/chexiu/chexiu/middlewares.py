...
class ChexiuNewProxyMiddleware(object):
    def __init__(self):
        self.count = 0
...
class ChexiuNewUserAgentMiddleware(UserAgentMiddleware):
    def process_request(self, request, spider):
...
class ChexiuSpiderMiddleware(object):
...
class ChexiuDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
